...
@bind predictions confirm(PlutoUI.combine() do Child
		md"""
		I think ``f_{\mathrm{bump}}`` has $(Child(Select(["choose...", "ridge-like", "separable", "neither"]; default="separable"))) structure.

		This means the $(Child(Select(["choose...", "interleaved", "grouped", "fused"]; default="grouped"))) bit layout should yield low bond dimensions.
		"""
	end)
...
manifest_format = "2.0"
project_hash = "ad7562829e57df64df57963a7ea935d81f7b1336"
